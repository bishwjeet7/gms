...
router.patch('/updateJob/:jobId',requireAuth.authMiddleware ,validate.job_id , controller.updateJob );
...
router.patch('/updateAnnouncement/:_id', requireAuth.authMiddleware, controller.updateAnnouncement);
